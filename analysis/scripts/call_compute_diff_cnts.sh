...
# dfs directories
dfs_input_dir_1=$root/../archive/ende_beam_wmt14.en-de.transformer_new_beam_20
...
# beam directories
beam_input_dir_1=$root/../archive/ende_beam_wmt14.en-de.transformer_new
...
python3 $root/compute_score_diff_cnts.py --beam_input_dir_1 $dfs_input_dir_1 --beam_input_dir_2 $beam_input_dir_1 --beam 5 --reference_file $ref_file
